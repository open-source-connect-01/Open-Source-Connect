      ...
      <main className="flex-1">
        ...
        >
          <div className="relative">
            ...
            <div className="relative max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-20 pb-8 sm:pb-12">
            <span className="text-[10px] sm:text-[11px] font-bold tracking-[0.28em] text-slate-400 uppercase">
              {data.edition}
            </span>

            <div className="mt-4 sm:mt-5 border-l-4 border-[#F2811D] pl-4 sm:pl-6">
              <h1 className="text-[28px] sm:text-[44px] lg:text-[52px] font-extrabold text-white leading-[1.12] tracking-tight">
                {data.title}
              </h1>
            </div>

            <p className="mt-4 sm:mt-6 text-[13px] sm:text-[15px] text-slate-300 leading-relaxed max-w-[560px]">
              {data.subtitle}
            </p>

            <div className="mt-6 sm:mt-8 flex flex-wrap items-center gap-2.5 sm:gap-4">
              <span className="inline-flex items-center h-8 px-3 sm:px-3.5 bg-[#F2811D] text-[#0A0F24] text-[10.5px] sm:text-[12px] font-extrabold tracking-wide rounded-[3px]">
                {data.dateRange}
              </span>
              <span className="inline-flex items-center gap-1.5 text-[12px] sm:text-[13.5px] text-slate-300">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-white/10">
                {data.stats.map((stat) => (
                  <div key={stat.label} className="py-6 sm:py-10 text-center px-2">
                    ...
                    <div className="mt-2 text-[8.5px] xs:text-[9.5px] sm:text-[10px] font-bold tracking-[0.16em] text-slate-400 uppercase">
                      {stat.label}
                    </div>
                  </div>
                ))}
          ...
          <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
              <div>
                ...
                <h2 className="mt-2.5 sm:mt-3 text-[24px] sm:text-[32px] font-extrabold text-navy leading-[1.2] tracking-tight max-w-[380px]">
                  {data.aboutHeading}
                </h2>
              ...
              <div>
                <div className="space-y-4">
                  {data.aboutParagraphs.map((p, i) => (
                    <p key={i} className="text-[13px] sm:text-[14.5px] text-slate-500 leading-relaxed">
                      {p}
                    </p>
                  ))}
                </div>
                ...
                <ul className="mt-6 space-y-2.5">
                  {data.aboutBullets.map((b) => (
                    <li key={b} className="flex items-start gap-2.5 text-[12.5px] sm:text-[13.5px] text-slate-600 font-medium">
        ...
        {/* ===== SPEAKERS ===== */}
        <section className="w-full bg-white pb-12 sm:pb-20 lg:pb-24">
          <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-12">
              <span className="text-[10px] font-bold tracking-[0.24em] text-gray-400 uppercase">
                Meet the Speakers
              </span>
              <h2 className="mt-2.5 sm:mt-3 text-[24px] sm:text-[32px] font-extrabold text-navy tracking-tight">
        ...
        <section className="w-full bg-white pb-12 sm:pb-20 lg:pb-24">
          <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-[900px] mx-auto">
              <div className="flex flex-wrap items-center gap-2 sm:gap-4 pb-3 sm:pb-4 border-b border-gray-200 text-[9px] sm:text-[10.5px] font-bold tracking-[0.14em] text-slate-500 uppercase">
                ...
                {data.scheduleItems.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-4">
                      ...
                      <span className="text-[11px] sm:text-[12.5px] text-slate-400 font-medium sm:whitespace-nowrap shrink-0">
                        {item.speaker}
                      </span>
                    </div>
                  </div>
